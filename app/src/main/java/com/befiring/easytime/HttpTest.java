...
public class HttpTest {
    ...
    public static void main(String[] args) {
        //发送 GET 请求
        String s=sendGet("http://japi.juhe.cn/joke/content/list.from", "key=8e10be3f8234d89f061d18ba5150a7d1&page=2&pagesize=10&sort=asc&time=1418745237");
        Gson gson=new Gson();
